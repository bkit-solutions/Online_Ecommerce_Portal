...
public class OrderService {
	...
	public Order placeOrder(Long userId, List<Long> cartItemIds, double totalAmount,String address) {
	 ...
	 // Set multiple recipients (e.g., user and admin email)
	    message.setTo(new String[] { user.getEmail(), "pooja72467@gmail.com" });
	    ...
	    emailContent.append("Thank you for shopping with us at the Smart-Trends portal! 🎉\n\n");
	    ...
	    emailContent.append("– Smart-Trends Portal Team");
